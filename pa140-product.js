const pa140Products = {
  "white-4": {
    sku: "PA140-T4",
    name: "Bàn ăn gấp gọn 140cm Màu Trắng Giả Vân Đá - 4 ghế",
    salePrice: "4.090.000 VNĐ",
    originalPrice: "5.890.000 VNĐ",
    image: "assets/pian-hero-kitchen-table.png"
  },
  "black-4": {
    sku: "PA140-D4",
    name: "Bàn ăn gấp gọn 140cm Màu Đen Giả Vân Đá - 4 ghế",
    salePrice: "4.090.000 VNĐ",
    originalPrice: "5.890.000 VNĐ",
  ...
  "wood-4": {
    sku: "PA140-G4",
    name: "Bàn ăn gấp gọn 140cm Màu Nâu Giả Vân Gỗ Tự Nhiên - 4 ghế",
    salePrice: "4.090.000 VNĐ",
    originalPrice: "5.890.000 VNĐ",
  ...
  "white-6": {
    sku: "PA140-T6",
    name: "Bàn ăn gấp gọn 140cm Màu Trắng Giả Vân Đá - 6 ghế",
    salePrice: "4.790.000 VNĐ",
    originalPrice: "6.890.000 VNĐ",
    image: "assets/pian-hero-kitchen-table.png"
  },
  "black-6": {
    sku: "PA140-D6",
    name: "Bàn ăn gấp gọn 140cm Màu Đen Giả Vân Đá - 6 ghế",
    salePrice: "4.790.000 VNĐ",
    originalPrice: "6.890.000 VNĐ",
  ...
  "wood-6": {
    sku: "PA140-G6",
    name: "Bàn ăn gấp gọn 140cm Màu Nâu Giả Vân Gỗ Tự Nhiên - 6 ghế",
    salePrice: "4.790.000 VNĐ",
    originalPrice: "6.890.000 VNĐ",
...
const product = pa140Products[variantKey] || pa140Products["black-4"];
...
function createProductCard(key) {
  const item = pa140Products[key];
  const article = document.createElement("article");
  const href = `pa140-product.html?variant=${encodeURIComponent(key)}`;
  article.innerHTML = `
...
viewedProductKeys = [
  variantKey,
  ...viewedProductKeys.filter((key) => key !== variantKey && pa140Products[key])
].slice(0, 6);
...
document.querySelector("#open-order-form").addEventListener("click", () => {
  ...
  window.location.href = `checkout.html?series=pa140&variant=${encodeURIComponent(variantKey)}&quantity=${quantity}`;
});
