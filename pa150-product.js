const pa150Products = {
  "white-4": {
    sku: "PA150-T4",
    name: "Bàn ăn gấp gọn 150cm Màu Trắng Giả Vân Đá - 4 ghế",
    salePrice: "4.190.000 VNĐ",
    originalPrice: "5.990.000 VNĐ",
    image: "assets/pian-hero-kitchen-table.png"
  },
  "black-4": {
    sku: "PA150-D4",
    name: "Bàn ăn gấp gọn 150cm Màu Đen Giả Vân Đá - 4 ghế",
    salePrice: "4.190.000 VNĐ",
    originalPrice: "5.990.000 VNĐ",
  ...
  "wood-4": {
    sku: "PA150-G4",
    name: "Bàn ăn gấp gọn 150cm Màu Nâu Giả Vân Gỗ Tự Nhiên - 4 ghế",
    salePrice: "4.190.000 VNĐ",
    originalPrice: "5.990.000 VNĐ",
  ...
  "white-6": {
    sku: "PA150-T6",
    name: "Bàn ăn gấp gọn 150cm Màu Trắng Giả Vân Đá - 6 ghế",
    salePrice: "4.890.000 VNĐ",
    originalPrice: "6.990.000 VNĐ",
    image: "assets/pian-hero-kitchen-table.png"
  },
  "black-6": {
    sku: "PA150-D6",
    name: "Bàn ăn gấp gọn 150cm Màu Đen Giả Vân Đá - 6 ghế",
    salePrice: "4.890.000 VNĐ",
    originalPrice: "6.990.000 VNĐ",
  ...
  "wood-6": {
    sku: "PA150-G6",
    name: "Bàn ăn gấp gọn 150cm Màu Nâu Giả Vân Gỗ Tự Nhiên - 6 ghế",
    salePrice: "4.890.000 VNĐ",
    originalPrice: "6.990.000 VNĐ",
...
const product = pa150Products[variantKey] || pa150Products["black-4"];
...
function createProductCard(key) {
  const item = pa150Products[key];
  const article = document.createElement("article");
  const href = `pa150-product.html?variant=${encodeURIComponent(key)}`;
  article.innerHTML = `
...
viewedProductKeys = [
  variantKey,
  ...viewedProductKeys.filter((key) => key !== variantKey && pa150Products[key])
].slice(0, 6);
...
document.querySelector("#open-order-form").addEventListener("click", () => {
  ...
  window.location.href = `checkout.html?series=pa150&variant=${encodeURIComponent(variantKey)}&quantity=${quantity}`;
});
